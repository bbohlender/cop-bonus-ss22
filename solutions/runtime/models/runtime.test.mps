...
<model ref="r:bb784100-d406-4292-a02b-112147e9e252(runtime.test)">
  ...
  <node concept="280Yd$" id="3L0XDiOhuey">
    ...
    <node concept="kiHAi" id="7vEudxzCmYY" role="281bNN">
      <node concept="3OkFif" id="7vEudxzCmZv" role="kiHAk">
        <property role="3OkFia" value="5" />
      </node>
      <node concept="3OkFif" id="7vEudxzCmZy" role="kiHAl">
        <property role="3OkFia" value="2" />
      </node>
    </node>
    <node concept="kiVtQ" id="7vEudxzCBPZ" role="281bNN">
      <node concept="3OkFif" id="7vEudxzCBQf" role="kiVtC">
        <property role="3OkFia" value="5" />
      </node>
